...
from model.LongCompNet import AttLongRangeCompressor
    ...
    def train(self, epoch, total_epoch):
        ...
        with tqdm(total=len(self.trainloader)) as tbar: 
            for i,data in enumerate(self.trainloader):    
                ...
                img = data.cuda()
                recon_img, mse_loss,  bpp = self.model(img)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--trainpath", default = "your path/val/images",  help='training dataset path')
    ...
    model = AttLongRangeCompressor(out_channel_N,  out_channel_M, lamb = 8192)    
